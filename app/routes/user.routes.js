 ...
 * /:
 *   get:
 *     description: Returns a the tasks of a user given his identifier.
 *     responses:
 *       200:
 *         description: A user list of json tasj objects.
 */
router.route('/:id/tasks').get(UsersCtrl.findUserTasks);
